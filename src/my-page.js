...
import { getStudentClient, getStudentProfile, getStudentMembership, saveUserSettings } from './supabase.js?v=20260911-mobile1';
import { initialiseMemberPreferences } from './member-preferences.js?v=20260911-mobile1';
import { getSettings, updateSettings, onSettingsChange, escapeHTML as e } from './store.js?v=20260911-mobile1';
import { loadStudentAccess, applyStudentFeatureVisibility, featureAllowed } from './student-visibility.js?v=20260911-mobile1';
import { fetchStudentAnnouncements, toggleCurriculumFavorite } from './curriculum-api.js?v=20260911-mobile1';
import { AVATAR_BUCKET, avatarPath, avatarReference, compactAvatar, displayProfileAvatar } from './profile-api.js?v=20260911-mobile1';
import { personalCardMarkup, bindPersonalAudio } from './personal-cards.js?v=20260911-mobile1';
import { buildPhraseCatalog } from './data.js?v=20260911-mobile1';
