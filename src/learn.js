import { createCurriculumVisual, visualSpecFor } from './curriculum-visuals.js?v=20260910-member1';
import {
...
import { loadUserSettings, saveUserSettings } from "./supabase.js?v=20260910-member1";
import { applyLanguageMode, languageModeFromSettings, uiText } from "./i18n.js?v=20260910-member1";

import { curriculumAudioSamples, curriculumPrimaryAudio } from "./curriculum-audio.js?v=20260910-member1";
import { VOICE_PROFILES } from "./speech-contract.js?v=20260910-member1";
