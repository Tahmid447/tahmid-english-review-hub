import { getStudentClient, getStudentSession } from './supabase.js?v=20260911-mobile2';
import { campaignQuote, deadlineLabel, remainingTime, escapeHtml as e } from './campaigns.js?v=20260911-mobile2';
